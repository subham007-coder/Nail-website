...
const products = [
	{
		...
		images: {
			default:
				'https://nailknack.com/cdn/shop/files/nailknack-41475.webp?v=1699271161&width=360',
			hover:
	...
	},
	{
		...
		images: {
			default:
				'https://nailknack.com/cdn/shop/files/AnyConv.com__Untitleddesign_5ff1b2d9-b964-497e-90c1-02a847862935.webp?v=1697539876&width=360',
			hover:
				'https://nailknack.com/cdn/shop/files/AnyConv.com__Untitleddesign_2_d28a6844-4386-4286-84a0-284ef960047e.webp?v=1699124940&width=720',
		},
	},
...
function ProductSlider() {
	...
	return (
		<div className="container mx-auto px-4 py-6" data-animation="fade-up">
			<div
				className="flex items-center justify-between mb-4"
				data-animation="slide-in"
			>
				<h2 className="text-2xl md:text-3xl font-bold">
					Designer Luxe Press On Nails Set
				</h2>
