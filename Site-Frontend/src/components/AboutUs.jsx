...
function AboutUs() {
  ...
  return (
    <div className="container mx-auto px-4 py-4">
      {/* Main Heading */}
      <h1
        className="text-3xl md:text-4xl lg:text-4xl font-bold text-center mb-12"
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
        ...
        <div className="space-y-6" data-animation="stagger">
          ...
          <p className="text-gray-600" data-stagger>
            NailKnack® is a nail paradise for fashion-forward women who take
            nail care seriously. Apply NailKnack® to transform your hand glance
            and self-confidence. Our products will always match your mood with
            quality and craftsmanship designed to satisfy your comfort and style
            needs.
          </p>
          <button
