...
const categories = [
  ...
  },
  {
    ...
    name: "Holiday Nails",
    image:
      "https://nailknack.com/cdn/shop/collections/Untitled_design_1.jpg?v=1720775202&width=535",
  },
  {
    id: 3,
    name: "Casual Nails",
    image:
      "https://nailknack.com/cdn/shop/collections/nailknack-43102.jpg?v=1718626148&width=535",
  },
  {
    id: 4,
    name: "Party Nails",
    image:
      "https://nailknack.com/cdn/shop/collections/nailknack-41469.jpg?v=1699032997&width=535",
  },
];
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        {categories.map((category) => (
          ...
          >
            ...
            <button
              className="absolute bottom-6 left-1/2 -translate-x-1/2 bg-white text-gray-900 px-6 py-2 rounded-full 
