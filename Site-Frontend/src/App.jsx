      ...
      <ScrollProvider>
        ...
        <Routes>
          ...
          <Route
            path="/contact"
            element={
              isAuthenticated ? <Contact /> : <Login onLogin={handleLogin} />
            }
          />
          ...
          <Route
            path="/tutorial"
            element={
              isAuthenticated ? <Tutorial /> : <Login onLogin={handleLogin} />
            }
          />
          ...
          <Route
            path="/shop"
            element={
              isAuthenticated ? <Shop /> : <Login onLogin={handleLogin} />
            }
          />
          ...
          <Route
            path="/wishlist"
            element={
              isAuthenticated ? <Wishlist /> : <Login onLogin={handleLogin} />
            }
          />
          ...
          <Route
            path="/cart"
            element={
              isAuthenticated ? <Cart /> : <Login onLogin={handleLogin} />
            }
          />
          ...
          <Route
            path="/account"
            element={
              isAuthenticated ? <Account /> : <Login onLogin={handleLogin} />
            }
          />
